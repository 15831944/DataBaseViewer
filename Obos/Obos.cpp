...
// Obos.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CObosApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CObosApp::OnAppAbout)
...
CObosApp::CObosApp()
{
	...
	SetAppID(_T("Obos.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CObosApp

CObosApp theApp;


// инициализация CObosApp

BOOL CObosApp::InitInstance()
{
...
// обработчики сообщений CObosApp
...
void CObosApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CObosApp настройка методов загрузки и сохранения

void CObosApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CObosApp::LoadCustomState()
{
}

void CObosApp::SaveCustomState()
{
}
